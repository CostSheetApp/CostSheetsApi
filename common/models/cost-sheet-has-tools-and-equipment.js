...
module.exports = function(Costsheethastoolsandequipment) {
  ...
  Costsheethastoolsandequipment.remoteMethod('TotalToolEquipment', {
    http: {
      path: '/:id/TotalToolEquipment',
      verb: 'get',
    },
  ...
  Costsheethastoolsandequipment.remoteMethod('DetailsToolsAndEquipment', {
    http: {
      path: '/:id/DetailsToolsAndEquipment',
      verb: 'get',
    },
