...
module.exports = function(Costsheethasmaterials) {
  Costsheethasmaterials.TotalMaterial = function(id, cb) {
    ...
    on his.materialId = costHis.materialId and his.regionId = costHis.regionId and his.createdAt = costHis.createdAt where sheet.isDeleted = 0 \
    and sheet.costSheetId = ? ) as Mat group by Mat.costSheetId;";
